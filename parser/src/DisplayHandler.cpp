...
void DisplayHandler::displayValue(const char* value, TokenType valueType, unordered_map<const char*, const char*, CharPtrHash, CharPtrEqual> &variables)
{
...
void DisplayHandler::parseDSPL(Token *tokens, int &currentIndex, unordered_map<const char*, const char*, CharPtrHash, CharPtrEqual> &variables)
{
